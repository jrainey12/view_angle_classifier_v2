...
def main(base_dir):
    ...
    sil_out_dir = "dataset/val/sil" 
    pose_out_dir = "dataset/val/pose"
    label_dir = "dataset/val/"
...
def get_sample(base_dir,number_of_subjects):
    ...
    while empty:
        ...
        subject = '%03d' % randrange(95,number_of_subjects+1+95)
        ...
        pose_dir = join(base_dir,"pose/val", path + ".pkl")
        ...
        img_dir = join(base_dir,"sils/val", path) 
