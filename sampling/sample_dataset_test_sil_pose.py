...
def main(base_dir):
    ...
    number_of_samples = 19968
    number_of_subjects = 15

    sil_out_dir = "dataset/test/sil" 
    pose_out_dir = "dataset/test/pose"
    label_dir = "dataset/test/"
...
def get_sample(base_dir,number_of_subjects):
    ...
    while empty:
        ...
        empty = False
        subject = '%03d' % randrange(110,number_of_subjects+1+110)	
        ...
        pose_dir = join(base_dir,"pose/test", path + ".pkl")
        ...
        img_dir = join(base_dir,"sils/test", path) 
